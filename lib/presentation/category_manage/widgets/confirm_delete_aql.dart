...
class ConfirmDeleteAqlPopup extends StatelessWidget {
  ConfirmDeleteAqlPopup({super.key, required this.aql});
  final AQLModel aql;
          ...
          child: Column(
            ...
            children: [
              ...
              Text.rich(
                ...
                TextSpan(
                  text: 'Bạn chắc chắn muốn xóa chi tiêu',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.black,
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  CustomButton(
                    ...
                    onPressed: () {
                      controller.deleteAql(aql.id.toString());
                    },
                    borderColor: null,
